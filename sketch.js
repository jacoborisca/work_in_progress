ctl= {x:0,y:0,z:0}
mauStart= function () {
ws= new WebSocket("ws://localhost:10001"); ws.onmessage= function (ev) { console.log("msg",ev.data); var d= ev.data.match(/(.):\[(-?\d+\.\d+)/); if (d) { ctl[d[1]]= parseFloat(d[2]) }}

sendX= function sendX() { ws.send("mouse/x,["+mouseX/width); }
sendXi= setInterval("sendX()",100);
}
mauStart();
...
preload= function preload() {
  soundFile = loadSound('/app/js_p5_viz/p5-music-viz/music/YACHT_-_06_-_Summer_Song_Instrumental.mp3');
}
